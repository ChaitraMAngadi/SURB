        ...
        <div class="col-lg-12">
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-title">
                    ...
                    <h5 class="shop_title">Daily Reports </h5>
    ...
    options: {
        ...
        tooltips: {
            ...
            callbacks: {
                ...
                <div class="row">
                   <form method="post" class="form-horizontal" enctype="multipart/form-data" action="<?php echo base_url(); ?>vendors/order_daily_reports/datewiseReport">
                    ...
                    ?>" required=""></div><div class="col-md-2 action" style="bottom:-22px">
                        ...
                        <a href="<?php echo base_url(); ?>vendors/order_daily_reports" class="btn btn-warning">RESET</a>
