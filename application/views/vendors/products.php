...
<!--                        <a href="<?= base_url() ?>vendors/dashboard">
                ...
                <div class="ibox-content">
                    <form method="post" action="<?= base_url() ?>vendors/products">
                        ...
                        <a href="<?= base_url('vendors/products') ?>"><input type="button" class="btn btn-danger mt-2" name="reset" value="Reset"></a>
                    </form>
