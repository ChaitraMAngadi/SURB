                ...
                <div class="ibox-content">
                    ...
                    <div class="row">
                        <div class="col-md-12">    
                            ...
                            <div class="col-md-2">
                                <a href="<?php echo base_url(); ?>vendors/orders_daily?status=2">
                                    <div class="widget style1 <?= $this->input->get('status') == 2 ? 'navy-bg' : 'blue-bg' ?>">
                                        <div class="row">
                                            <?php
                                            $in_accept = $this->common_model->count_rows_with_conditions('orders', ['order_status' => 2, 'vendor_id' => $shop_id,'order_date'=>date('Y-m-d')]);
                            ...
                            // exit;?>
                            <div class="col-md-2">
                                <a href="<?php echo base_url(); ?>vendors/orders_daily?status=3">
                                    <div class="widget style1 <?= $this->input->get('status') == 3 ? 'navy-bg' : 'blue-bg' ?>">
                                        <div class="row">
                                            <?php
                                            $in_courier = $this->common_model->count_rows_with_conditions('orders', ['order_status' => 3, 'vendor_id' => $shop_id,'order_date'=>date('Y-m-d')]);
                                            ?>
                                            <div class="col-xs-12 text-center">
                            ...
                            <div class="col-md-2">
                                <a href="<?php echo base_url(); ?>vendors/orders_daily?status=8">
                                    <div class="widget style1 <?= $this->input->get('status') == 8 ? 'navy-bg' : 'blue-bg' ?>">
                                        <div class="row">
                                            <?php
                                            $in_returned = $this->common_model->count_rows_with_conditions('orders', ['order_status' => 8, 'vendor_id' => $shop_id,'order_date'=>date('Y-m-d')]);
                                            ?>
                                            <div class="col-xs-12 text-center">
                                                <span> Pick up  </span>
                            ...
                            <?php }?>
                            <div class="col-md-2">
                                <a href="<?php echo base_url(); ?>vendors/orders_daily?status=4">
                                    <div class="widget style1 <?= $this->input->get('status') == 4 ? 'navy-bg' : 'blue-bg' ?>">
                                        <div class="row">
                                            <?php
                                            $in_shipped = $this->common_model->count_rows_with_conditions('orders', ['order_status' => 4, 'vendor_id' => $shop_id,'order_date'=>date('Y-m-d')]);
                                            ?>
                                            <div class="col-xs-12 text-center">
                                                <span> Shipped  </span>
                            ...
                            <div class="col-md-2">
                                <a href="<?php echo base_url(); ?>vendors/orders_daily?status=5">
                                    <div class="widget style1 <?= $this->input->get('status') == 5 ? 'navy-bg' : 'blue-bg' ?>">
                                        <div class="row">
                                            <?php
                                            $in_delivered = $this->common_model->count_rows_with_conditions('orders', ['order_status' => 5, 'vendor_id' => $shop_id,'order_date'=>date('Y-m-d')]);
                                            ?>
                                            <div class="col-xs-12 text-center">
                                                <span> Delivered  </span>
                            ...
                            <div class="col-md-2">
                                <a href="<?php echo base_url(); ?>vendors/orders_daily?status=6">
                                    <div class="widget style1 <?= $this->input->get('status') == 6 ? 'navy-bg' : 'blue-bg' ?>">
                                        <div class="row">
                                            <?php
                                            $in_cancelled = $this->common_model->count_rows_with_conditions('orders', ['order_status' => 6, 'vendor_id' => $shop_id,'order_date'=>date('Y-m-d')]);
                                            ?>
                                            <div class="col-xs-12 text-center">
                                                <span> Cancelled  </span>
                            ...
                            <div class="col-md-2">
                                <a href="<?php echo base_url(); ?>vendors/orders_daily?status=7">
                                    <div class="widget style1 <?= $this->input->get('status') == 7 ? 'navy-bg' : 'blue-bg' ?>">
                                        <div class="row">
                                            <?php
                                            $in_returned = $this->common_model->count_rows_with_conditions('orders', ['order_status' => 7, 'vendor_id' => $shop_id,'order_date'=>date('Y-m-d')]);
                                            ?>
                                            <div class="col-xs-12 text-center">
                                                <span> Returned  </span>
                                                <h2 class="font-bold"><?php echo $in_returned; ?></h2>
                    ...
                    <hr>
                    <form method="get" action="<?= base_url() ?>vendors/orders_daily" id="filter_purchase_form">
                        ...
                        <div class="row">
                            <div class="col-sm-2">
                                <div class="input-group">
                                    ...
                                    <a href="<?= base_url() ?>vendors/orders_daily"><input type="button" class="btn btn-danger mt-2" name="reset" value="Reset"></a>&nbsp;&nbsp;
            ...
            <!--                                <td><?php
                                            ...
                                            <td>
                                                <?php if ($ord->order_status == 1) { ?>
                                                    ...
                                                    <a onclick="return confirm('Are you sure You want to accept this product?')" href="<?php echo base_url(); ?>vendors/orders_daily/view_aceept_status/<?php echo $ord->id; ?>"><button class="btn btn-xs btn-info"><i class="fa fa-check" aria-hidden="true"></i>  Accept </button></a>


                                                    <a onclick="return confirm('Are you sure You want to cancel this product?')" href="<?php echo base_url(); ?>vendors/orders_daily/cancel_status/<?php echo $ord->id; ?>"><button class="btn btn-xs btn-danger"><i class="fa fa-ban"></i>  Cancel </button></a>
...
<?php if($delhivery_name=='self'){?>
                                                    <a onclick="return confirm('Are you sure you want to assign to Courier?')" href="<?php echo base_url(); ?>vendors/orders_daily/assigned_deliveryBoy/<?php echo $ord->id; ?>"><button class="btn btn-info" title="Change Assign to Courier"> Assign to Courier </button></a><br><br>
...
<?php }else if($delhivery_name=='delhivery'){?>
    <form method="post" action="<?php echo base_url(); ?>vendors/orders_daily/ordercreate/<?php echo $ord->id; ?>" class="delhiveryForm" data-ordid="<?php echo $ord->id; ?>">
...
if($delhivery_name=='self'){?>
                                                    ...
                                                    ?>
                                                     <a href="<?php echo base_url(); ?>vendors/orders_daily/update_order/<?php echo $ord->id; ?>/<?php echo $waybillgenerated;?>" class="btn btn-warning" title="update order">update Order</a>
...
if ($displayButton && $delhivery_name == 'delhivery' && $waybillgenerated!=''&& $count==1 && $order_details_qry_res->warehouse_name==$result_query1[0]->warehouse_name) {
    ...
    <button type="button" class="btn btn-primary text-white" title="add to pickup request">
        ...
        <a href="<?php echo base_url(); ?>vendors/orders_daily/addOrderDetails/<?php echo $ord->id; ?>/<?php echo $result_query1[0]->pickup_id; ?>/<?php echo $ord->session_id;?>/<?php echo $warehouse_name_encoded;?>" style="color:white;">Add to pickup</a>
    </button>
    <?php
}
...
foreach ($result_query1 as $res) {
    ...
    // print_r($res->warehouse_name);?>
<button type="button" class="btn btn-primary text-white" title="add to pickup request">
        <a href="<?php echo base_url(); ?>vendors/orders_daily/addOrderDetails/<?php echo $ord->id; ?>/<?php echo $res->pickup_id; ?>/<?php echo $ord->session_id;?>/<?php echo $warehouse_name_encoded;?>" style="color:white;">Add to pickup</a>
    </button>
<?php } } }
?>
                                                    ...
                                                    <a href="<?php echo base_url(); ?>vendors/orders_daily/shippingLabelGeneration/<?php echo $waybill; ?>/<?php echo $ord->id;?>" class="btn btn-info" title="Print the label">Download PDF</a>        
                                                    <?php }?>
...
// if($waybillgenerated!='' && $vendor_qry_res->delivery_partner == 'delhivery'){?>
                                                    <!-- <a href="<?php echo base_url(); ?>vendors/orders_daily/shipment_delhivery/<?php echo $ord->id; ?>" class="btn btn-danger" title="Change to shipped">Shipment</a> -->
                                             <?php   
                                             }

                                                else if ($ord->order_status == 4) { ?>
                                                    <a class="btn btn-xs btn-success">Order Shipped</a>
                                                    <a onclick="return confirm('Are you sure you want to Complete this order?')" href="<?php echo base_url(); ?>vendors/orders_daily/view_complete_status/<?php echo $ord->id; ?>"><button class="btn btn-warning" title="Change to Delivered"> Complete </button></a>
                                        ...
                                        // }?>
                                         ...
                                         <?php
                                            ...
                                            <td><a href="<?php echo base_url(); ?>vendors/orders_daily/orderDetails/<?php echo $ord->id; ?>">
                                    ...
                                    <div class="modal fade" id="exampleModal<?php echo $ord->id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form method="post" class="form-horizontal" enctype="multipart/form-data"  action="<?= base_url() ?>vendors/orders_daily/shipment">
                                                    <div class="form-group">
...
<script type="text/javascript">
    ...
    function updateStatus(value, order_id)
    {
        ...
        {
            $.ajax({
                url: "<?php echo base_url(); ?>/vendors/orders_daily/changeStatus",
                method: "POST",
                ...
                success: function (data)
                {
                    if (data == 'success')
                    {
                        ...
                        window.location.href = "<?php echo base_url(); ?>vendors/orders_daily";
                    }
                }
            });
        }
...
//         $.ajax({
//             url: "<?php echo base_url(); ?>/vendors/orders_daily/setLocation",
//             method: "POST",
...
//     var formAction = "<?php echo base_url(); ?>vendors/orders_daily/shippingcost/" + ordId;
