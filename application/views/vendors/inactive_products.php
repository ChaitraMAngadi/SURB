...
function goBack() {
  ...
  window.history.back();
                ...
                <div class="ibox-content">
                    ...
                    <form method="post" action="<?=base_url()?>vendors/inactive_products">
                        ...
                        <a href="<?= base_url('vendors/inactive_products') ?>"><input type="button" class="btn btn-danger mt-2" name="reset" value="Reset"></a>
                    </form>
...
?>
     <?php if ($show_questionaries): ?>
                    ...
                    <?php if ($show_questionaries): ?>
                                        ...
                                        <a href="<?= base_url() ?>vendors/inactive_products/linkvariant/<?php echo $pr->id; ?>">

                                                <button class="btn btn-xs btn-info">  Products </button>

                                            </a>

                                            <a href="<?= base_url() ?>vendors/inactive_products/edit/<?php echo $pr->id; ?>">
...
//            window.history.back();
        ...
        $('.delete_product').on('click', function () {
            ...
            if (confirm) {
                ...
                var location = '<?= base_url() ?>vendors/inactive_products/delete_product?product_id=' + product_id;
