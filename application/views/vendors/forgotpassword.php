    ...
    <body class="gray-bg">
        ...
        <div class="middle-box text-center loginscreen animated fadeInDown customLogin" style="width:350px">
            <div>
                ...
                <form class="m-t" role="form" action="<?php echo base_url(); ?>vendors/forgotpassword/sendEmail" method="post">
                    ...
                    <button type="submit" class="btn btn-primary block full-width m-b" id="btn_login">Send</button>
                <!--<p class="text-muted text-center"><small>Do not have an account?</small></p>
                <a class="btn btn-sm btn-white btn-block" href="register.html">Create an account</a>-->
                </form>
                <p><i class="fa fa-lock"></i> <a href="<?=base_url()?>vendors/login">Login</a></p>
