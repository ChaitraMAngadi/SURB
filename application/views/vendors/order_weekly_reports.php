...
<div class="wrapper wrapper-content animated fadeInRight">
 ...
 <canvas id="salesChart" width="800" height="200" style="background-color: #fff;"></canvas>
                <div class="ibox-content">
                    ...
                    <form method="post" class="form-horizontal" enctype="multipart/form-data" action="<?php echo base_url(); ?>vendors/order_weekly_reports/datewiseReport">
                ...
                </div><div class="col-md-2 action" style="bottom:-18px"><input type="submit" class="btn btn-primary" value="GET">
                <a href="<?php echo base_url(); ?>vendors/order_weekly_reports" class="btn btn-warning">RESET</a>    
            </div>
                    </form></div><br></hr>
                            ...
                            foreach ($orders_commission as $value) {
                               ...
                               <td style="width: 100%; height:100%;">
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <?php  $vendor_qry=$this->db->query("select * from vendor_shop where id='".$value->vendor_id."'");
     ...
     foreach ($jsonatt as $attribute) {
         ...
         if ($title_query && $value_query) {
             ...
             echo ucfirst($title_res->title) . ': ' . ucfirst($value_res->value);
                                ...
                                <!-- <td><?php echo $unit_price+$value->deliveryboy_commission+$value->gst; ?></td> -->
