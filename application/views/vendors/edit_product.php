    ...
    <div class="col-lg-12">
        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-title">
                ...
                <a href="<?= base_url() ?>vendors/products" style="float: right;">
            ...
            <div class="ibox-content" style="background-color: #f3f3f3;">
                ...
                <form method="post" class="form-horizontal" enctype="multipart/form-data"
                    action="<?= base_url() ?>vendors/inactive_products/update_product/">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <select class="form-control" name="cat_id" id="category"
                                onchange="getSubcategories(this.value,<?= $shop_id ?>)">
                    ...
                    <?php if ($show_questionaries): ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" name="ques_id" id="questionary"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <select name="option_id[]" id="options" class="form-control js-example-basic-multiple"
                                    multiple="multiple">
                    ...
                    foreach ($filters as $fil) {
                        ...
                        <div class="form-group filter">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" name="filter[]" onchange="getFilterOptions(this)">
                                    ...
                                    <option value="<?= $fil->id ?>" <?= in_array($fil->id, $filter_ids) ? 'selected' : '' ?>>
                                        <?= $fil->title ?></option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select name="filters_<?= $fil->id ?>[]" class="form-control js-example-basic-multiple"
                                    multiple="multiple">
                                    <?php
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <textarea class="ckeditor-desc" name="description"
                                id="description"><?php echo $products->descp; ?></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <textarea class="ckeditor-desc" name="about"
                                id="about"><?php echo $products->about; ?></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <textarea class="ckeditor-desc" name="how_to_use"
                                id="how_to_use"><?php echo $products->how_to_use; ?></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <textarea class="ckeditor-desc"
                                name="key_features"><?php echo $products->key_features; ?></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <textarea rows="5" cols="40" class="form-control" name="meta_tag_keywords"
                                id="meta_tag_keywords"><?php echo $products->meta_tag_keywords; ?></textarea>
...
<?php if($show_return): ?>
                        ...
                        <div id="noof_days">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" name="return_noof_days" id="return_noof_days" class="form-control"
                                        value="<?php echo $products->return_noof_days; ?>"
                    ...
                    <?php if ($products->variant_product == 'no') { ?>
                                                                ...
                                                                <option value="no" <?php
                                                                if ($products->variant_product == 'no') {
                                                                    echo 'selected="selected"';
                                                                }
                                                                ?>>No</option>
                    ...
                    <?php } else { ?>
                                                                  ...
                                                                  <option value="yes" <?php
                                                                  if ($products->variant_product == 'yes') {
                                                                      echo 'selected="selected"';
                                                                  }
                                                                  ?>>Yes</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" name="saleprice" id="saleprice" class="form-control"
                                        value="<?php echo $report->saleprice; ?>"
                                        oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..?)\../g, '$1');">
                                ...
                                <div class="row">
                                    ...
                                    foreach ($result as $value) {
                                        ...
                                        <div style="float: left;">
                                            ...
                                            <a href="<?= base_url() ?>vendors/products/deleteProductImageInEdit/<?php echo $value->id; ?>/<?php echo $products->id; ?>/<?php echo $value->variant_id; ?>"
                                                style="color: red;"><i class="fa fa-trash"></i></a>

                                            <img src="<?php echo base_url(); ?>uploads/products/<?php echo $value->image; ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="cart_limit" id="cart_limit" class="form-control"
                                oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..?)\../g, '$1');"
                                value="<?php echo $products->cart_limit; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text"
                                ...
                                value="<?php echo $products->priority; ?>">
                    ...
                    <!--                        <div class="hr-line-dashed"></div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                  <input type="text" name="package_weight" id="package_weight" class="form-control" value="<?php echo $report->package_weight; ?>">
                                                </div>
                                            </div>
                    
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">Package Length</label>
                                                <div class="col-sm-6">
                                                  <input type="text" name="package_length" id="package_length" class="form-control" value="<?php echo $report->package_length; ?>">
                                                </div>
                                            </div>
                    
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">Package Breadth</label>
                                                <div class="col-sm-6">
                                                  <input type="text" name="package_breadth" id="package_breadth" class="form-control" value="<?php echo $report->package_breadth; ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                  <input type="text" name="package_height" id="package_height" class="form-control" value="<?php echo $report->package_height; ?>">
                                                </div>
                                            </div>-->
                    ...
                    <div class="modal fade bd-example-modal-lg" data-backdrop="static" data-keyboard="false"
                        ...
                        <div class="modal-dialog modal-sm">
                            ...
                            <div class="modal-content"
                                style="width: 108px;color:#f37a20;text-align: center;margin:auto;">
