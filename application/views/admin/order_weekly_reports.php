...
<div class="wrapper wrapper-content animated fadeInRight">
        ...
        <div class="col-lg-12">
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-title">
                    ...
                    <h5 class="shop_title">Weekly Reports </h5>
 ...
 <canvas id="salesChart" width="800" height="200" style="background-color: #fff;"></canvas>
                ...
                <div class="ibox-content">
                    <div class="row">
                    <form method="post" class="form-horizontal" enctype="multipart/form-data" action="<?php echo base_url(); ?>admin/order_weekly_reports/datewiseReport">
                       <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="col-md-2 action" style="bottom:-22px">
                        <input type="submit" class="btn btn-primary" value="GET">&nbsp;
                        <a href="<?php echo base_url(); ?>admin/order_weekly_reports" class="btn btn-warning">RESET</a>
                    </div>
                    </form>
                </div>
                <hr/>
...
if (total_sales !== 0) {
    var formatted_total_sales = "$ " + total_sales + "<br> Total Weekly sales";
