...
<div class="container" style="margin: auto; width: 50%; padding: 10px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2); border-radius: 5px; background-color: #fff; display: flex; flex-direction: column; align-items: center;">
    ...
    <form action="<?= base_url('admin/notifications/notification_preferences'); ?>" method="post" style="width: 100%;">
        <div class="checkbox" style="margin-bottom: 20px;">
            <label style="font-size: 18px;"><input type="checkbox" id="select_all" name="preferences[all]" <?= !isset($preferences) || empty($preferences) || isset($preferences['all']) ? 'checked' : ''; ?>> All Notifications</label>
        </div>
        <div class="checkbox" style="margin-bottom: 20px;">
