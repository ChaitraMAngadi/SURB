    ...
    <body class="gray-bg">
        ...
        <div class="middle-box text-center loginscreen animated fadeInDown customLogin" style="width:350px">
            <div>
                ...
                <form class="m-t" role="form" action="<?php echo base_url(); ?>admin/forgotpassword/sendEmail" method="post">
                ...
                <p><i class="fa fa-lock"></i> <a href="<?=base_url()?>admin/login">Login</a></p>
