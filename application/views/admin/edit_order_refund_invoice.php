    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5>Edit Order Refund Invoice</h5>
                <div class="ibox-tools">
                    <a href="<?= base_url() ?>admin/order_refund_invoice">
            ...
            <div class="ibox-content">
                <form method="post" class="form-horizontal" enctype="multipart/form-data"  action="<?= base_url() ?>admin/order_refund_invoice/update">
