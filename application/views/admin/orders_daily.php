                ...
                <div class="ibox-content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <!--                            <div class="col-md-2">
                                                            <a href="<?php echo base_url(); ?>admin/orders_daily/pending/pending">
                                                                <div class="widget style1 navy-bg">
                                                                    <div class="row">
                            <?php
                            $current_date=date('Y-m-d');
                            $ord_qry = $this->db->query("select * from orders where order_status=1 and order_date='".$current_date."' group by session_id order by id desc");
                            ...
                            <div class="col-md-2">
                                <a href="<?php echo base_url(); ?>admin/orders_daily">
                                    <div class="widget style1 blue-bg">
                                        <div class="row">
                                            <?php
                                            $allorder_qry = $this->db->query("select * from orders where order_status != 1 and order_date='".$current_date."' group by session_id order by id desc");
                            ...
                            <div class="col-md-2">
                                <a href="<?php echo base_url(); ?>admin/orders_daily/pending/accepted_vendor">
                                    <div class="widget style1 navy-bg">
                                        <div class="row">
                                            <?php
                                            $in_accepted_count = 0;
                                            ...
                                            $in_accept = $this->common_model->get_data_with_condition(['order_status' => 2,'order_date'=>$current_date], 'orders');
                            ...
                            <div class="col-md-2">
                                <a href="<?php echo base_url(); ?>admin/orders_daily/pending/pickuorders">
                                    <div class="widget style1 blue-bg">
                                        <div class="row">
                                            <?php
                                            $in_courier_count = 0;
                                            //session id wise data
                                            $this->db->group_by('session_id');
                                            $in_courier = $this->common_model->get_data_with_condition(['order_status' => 3,'order_date'=>$current_date], 'orders');
                                            //multiple vendor orders in one session
                            ...
                            <div class="col-md-2">
                                <a href="<?php echo base_url(); ?>admin/orders_daily/pending/ondelivery">
                                    <div class="widget style1 blue-bg">
                                        <div class="row">
                                            <?php
                                            $in_shipped_count = 0;
                                            //session id wise data
                                            $this->db->group_by('session_id');
                                            $in_shipped = $this->common_model->get_data_with_condition(['order_status' => 4,'order_date'=>$current_date], 'orders');
                                            //multiple vendor orders in one session
                            ...
                            <div class="col-md-2">
                                <a href="<?php echo base_url(); ?>admin/orders_daily/pending/completed">
                                    <div class="widget style1 blue-bg">
                                        <div class="row">
                                            <?php
                                            ...
                                            //session id wise data
                                            $this->db->group_by('session_id');
                                            $in_delivered = $this->common_model->get_data_with_condition(['order_status' => 5,'order_date'=>$current_date], 'orders');
                                            //multiple vendor orders in one session
                            ...
                            <!--                            <div class="col-md-2">
                                                            <a href="<?php echo base_url(); ?>admin/orders_daily/pending/cancelled">
                                                                <div class="widget style1 blue-bg">
                                                                    <div class="row">
                            <?php
                            $cancelled_qry = $this->db->query("select * from orders where order_status=6 and order_date='".$current_date."' group by session_id order by id desc");
                            ...
                            <div class="col-md-2">
                                <a href="<?php echo base_url(); ?>admin/product_return_details">
                                    <div class="widget style1 navy-bg">
                                        <div class="row">
                                            <?php
                                            $return_qry = $this->db->query("select * from orders where order_status=7 and order_date='".$current_date."' group by session_id order by id desc");
                    ...
                    <hr>
                    <form method="get" action="<?= base_url() ?>admin/orders_daily" id="filter_purchase_form">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <div class="input-group">
                                    ...
                                    <a href="<?= base_url() ?>admin/orders_daily"><input type="button" class="btn btn-danger mt-2" name="reset" value="Reset"></a>
                                </div>
                            </div>
                        </div>
                    </form>
...
//                                $vendor = $ven->row();
            ...
            <!--                                <td><?php
                                            ...
                                            <td>
                                                ...
                                                <?php } else if ($display_status == 2) { ?>
                                                    ...
                                                    <a onclick="return confirm('Do you want to cancel this order?')" href="<?php echo base_url(); ?>admin/orders_daily/orderCancel/<?php echo $ord->session_id; ?>"><button class="btn btn-danger">Cancel</button></a>
            ...
            <!--                                                    <p><b>Courier Name :</b><?= $ord->tracking_name; ?></p>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?php echo base_url(); ?>admin/orders_daily/orderDetails/<?php echo $ord->session_id; ?>">
                                                    <button class="btn btn-xs btn-info"><i class="fa fa-eye" aria-hidden="true"></i>  View </button>
                                                </a><?php }?>
                                                <?php if ($display_status == 1) { ?>
                                                    <a href="<?php echo base_url(); ?>admin/orders_daily/orderCancel/<?php echo $ord->id; ?>/<?php echo $ord->user_id; ?>">
                                    ...
                                    <div class="modal fade" id="exampleModal<?php echo $ord->id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form method="post" class="form-horizontal" enctype="multipart/form-data"  action="<?= base_url() ?>admin/orders_daily/shipment">
...
<script type="text/javascript">
    ...
    /*function updateStatus(value,order_id)
     ...
     {
     $.ajax({
     url:"<?php echo base_url(); ?>/admin/orders_daily/changeStatus",
     method:"POST",
