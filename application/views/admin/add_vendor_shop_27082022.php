...
<!--                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" onkeypress="return isNumberKey(event)" title="Please enter exactly 10 digits" id="mobile" name="mobile" class="form-control" value="<?= ($old_data) ? $old_data['mobile'] : '' ?>">
                        </div>
                    </div>
                    <div class="form-group">
