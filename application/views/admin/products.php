 ...
 function goBack() {
   window.history.back();
                    ...
                    <div class="ibox-content">
                        ...
                        <form method="get" action="<?= base_url() ?>admin/products" id="filter_purchase_form">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <div class="input-group">
                                        ...
                                        <a href="<?= base_url() ?>admin/products"><input type="button" class="btn btn-danger mt-2" name="reset" value="Reset"></a>
                                    </div>
                                </div>
                            </div>
                        </form>
                            ...
                            <table class="table table-striped table-bordered table-hover dataTables-example" >
                                ...
                                <tbody>
                                    ...
                                    foreach ($products as $pr){
                                        ...
                                        $link_variant = $this->db->where(array("product_id" => $pr->pid))->get("link_variant")->row();

                                        $cart_count = $this->db->where(array("variant_id" => $link_variant->id , "check_out" => '1' ))->get("cart")->result();
                                        $cartsitem = count($cart_count);

                                        $whistlist_count = $this->db->where(array("variant_id" => $link_variant->id))->get("whish_list")->num_rows();
                                        ...
                                        <tr class="gradeX">
                                            ...
                                            <td><?php
                                                if ($pr->prod_status == 1) {
                                                    ?>
                                                    <a href="<?= base_url() ?>admin/products/changeStatus/<?= $pr->pid ?>/0"><button title="Change to inactive" class="btn btn-xs btn-danger">Inactive</button></a>
                                                    <?php
                                                } else if ($pr->prod_status == 0) {
                                                    ?>
                                                    <a href="<?= base_url() ?>admin/products/changeStatus/<?= $pr->pid ?>/1"><button title="Inactive" class="btn btn-xs btn-green">
                                                            Active
                                                        </button></a>
                                                    <?php
                                                }
                                                ?>
                                                <a href="<?= base_url() ?>admin/products/edit/<?php echo $pr->pid; ?>">
                                                    <button class="btn btn-xs btn-info"><i class="fa fa-pencil-square-o"></i>Edit</button>
                                                </a>
                                                <a href="<?= base_url() ?>admin/products/product_statatics/<?php echo $pr->pid; ?>">
                                                    <button class="btn btn-xs btn-info">Product Statatics</button>
                                                </a>
                                            </td>
