            ...
            <div class="ibox-content">
                <form method="post" class="form-horizontal" action="<?= base_url() ?>admin/locations/update/<?php echo $shop_id; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" name="pincode_id" id="pincode_id">
                                ...
                                foreach ($cities as $value) {
                                    ?>
                                    <option value="<?php echo $value->pincode; ?>" <?php
                                    if ($value->pincode == $location->pincode) {
                                        echo "selected='selected'";
                                    }
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="area" id="area" class="form-control onlyCharacter" placeholder="Enter Area" value="<?php echo $location->area; ?>">
                        </div>
                    </div>
