            ...
            <div class="ibox-content test">
                <form method="post" class="form-horizontal" enctype="multipart/form-data" action="<?= base_url() ?>admin/vendors_shops/update">
                    ...
                    <div class="col-sm-10"> 
                        ...
                        <option value="<?php echo $vendor_data->delivery_partner;?>" selected><?php echo $vendor_data->delivery_partner;?></option>
                        <?php if($vendor_data->delivery_partner!='delhivery'){?>
        <option value="delhivery">Delhivery</option>
        <?php }else if($vendor_data->delivery_partner!='self'){?>
...
<!--                     <div class="form-group">
                   ...
                   <!--  <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" id="pincode" name="pincode" class="form-control" value="<?php echo $vendor_data->pincode; ?>" minlength="6" maxlength="6" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..?)\../g, '$1');">
                        </div>
                    </div>
                    <!-- <div class="form-group">
                        <div class="col-sm-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" id="pan" name="pan" class="form-control" minlength="10" maxlength="10" value="<?php echo $vendor_data->pan; ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" id="aadhar" name="aadhar" class="form-control" minlength="12" maxlength="12" value="<?php echo $vendor_data->aadhar; ?>" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..?)\../g, '$1');">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" id="gst_number" name="gst_number" class="form-control" minlength="15" maxlength="15" value="<?php echo $vendor_data->gst_number; ?>">
                        </div>
                    </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" id="account_no" name="account_no" class="form-control" value="<?php echo $vendor_data->account_no; ?>" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..?)\../g, '$1');">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" id="bank_ifsccode" name="bank_ifsccode" class="form-control" maxlength="11" value="<?php echo $vendor_data->bank_ifsccode; ?>">
                        </div>
                    </div>
...
$("#bankname").keypress(function (e) {
    ...
    $("#accountholder_name").keypress(function (e) {
        //var key = e.keyCode;
        var valid = (e.which >= 65 && e.which <= 90) || (e.which >= 97 && e.which <= 122) || (e.which == 32);
        if (!valid) {
            e.preventDefault();
