            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        ...
                        <a href="<?= base_url() ?>admin/vendors_shops/add">
                ...
                <div class="ibox-content">
                   ...
                   <!--  <form class="form" action="">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <a href="<?= base_url() ?>admin/vendors_shops" class="btn btn-danger" style="margin-top: 24px">Reset</a>
                        </div>
                        </div>
...
<!--                                    <td class="center">
                                    ...
                                    <td class="center">
                                            <!-- <a href="<?= base_url() ?>/admin/vendors_shops/delete/<?php echo $shop->id; ?>"  onclick="if(!confirm('Are you sure you want to delete this Shop?')) return false;" >
                                        ...
                                        if ($shop->status == 1) {
                                            ?>
                                            <a href="<?= base_url() ?>admin/vendors_shops/changeStatus/<?= $shop->id ?>/0"><button title="Click to inactive" class="btn btn-xs btn-danger">Inactive</button></a>
                                            <?php
                                        } else if ($shop->status == 0) {
                                            ?>
                                            <a href="<?= base_url() ?>admin/vendors_shops/changeStatus/<?= $shop->id ?>/1"><button title="Click to active" class="btn btn-xs btn-green">
                                                Active
                                            </button></a>
                                            <?php
                                        }
                                       ...
                                       <a href="<?= base_url() ?>admin/vendors_shops/edit/<?= $shop->id ?>">
...
<!--                                            <button title="Products" class="btn btn-xs btn-success">
                                            ...
                                            <a href="<?= base_url() ?>admin/vendors_shops/vendor_products?shop_id=<?= $shop->id ?>">
                                            <button title="Products" class="btn btn-xs btn-success">
                                                Products (<?= $shop->total_products ?>)
                                            </button>
                                        </a>
                                        ...
                                        <!-- <a href="<?= base_url() ?>admin/vendors_shops/manage_locations?shop_id=<?= $shop->id ?>">
                                            <button title="Products" class="btn btn-xs btn-success">
                                                Manage Locations
                                            </button>
                                        </a> -->
                                        <!-- <a href="<?= base_url() ?>admin/vendors_shops/manage_shop_banners?shop_id=<?= $shop->id ?>"> -->
