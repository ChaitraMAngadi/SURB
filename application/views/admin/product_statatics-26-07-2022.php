...
<!--                                    <th>Product ID</th>-->
                            ...
                            <?php
                                ...
                                foreach ($users as $value) {
                                    ...
                                    $whistlist_count = $this->db->where(array("product_id"=>$product_id,"user_id"=>$value->id))->get("whish_list")->num_rows();
                                    ...
                                    $link_variant = $this->db->where(array("product_id"=>$product_id))->get("link_variant")->row();
                                    $cart_count = $this->db->where(array("user_id"=>$value->id,"variant_id"=>$link_variant->id))->get("cart")->num_rows();
                                    ...
                                    $cart_data = $this->db->get("cart")->result();
                                    $order_count = $this->db->where(array("session_id"=>$cart_data->session_id))->get("orders")->row();
                                    $payment_status = $order_count->payment_status;
                                  
                                    
                                ?>
                            <tr class="gradeX">
                            <td><?=$i?></td>
                            <td>First name : <?=$value->first_name;?><br/>
                                Last name : <?=$value->last_name;?><br/>
                                Email : <?=$value->email;?><br/>
                                Phone number : <?=$value->phone;?><br/>
                                Login time : <?=$value->login_time;?><br/>
                            </td>
<!--                            <td><?=$products->id;?></td>-->
