            ...
            <div class="ibox-content test">
                <form method="post" class="form-horizontal" enctype="multipart/form-data" action="<?= base_url() ?>admin/vendors_shops/insert">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" id="owner_name" name="owner_name" class="form-control" value="<?= ($old_data) ? $old_data['owner_name'] : '' ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Email</label>
                        <div class="col-sm-10">
                            <input type="email" id="email" name="email" class="form-control" value="<?= ($old_data) ? $old_data['email'] : '' ?>">
                        </div>
                    </div>
<!--                    <div class="form-group">
                        <label class="col-sm-2 control-label">Refferal Code</label>
                        <div class="col-sm-10">
                            <input type="text" id="refferalcode" name="refferalcode" class="form-control" value="<?= ($old_data) ? $old_data['email'] : '' ?>">
                        </div>
                    </div>-->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" onkeypress="return isNumberKey(event)" title="Please enter exactly 10 digits" id="mobile" maxlength="10" name="mobile" class="form-control" value="<?= ($old_data) ? $old_data['mobile'] : '' ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Password</label>
                        <div class="col-sm-10">
                            <input type="text" id="password" name="password" class="form-control" value="<?= ($old_data) ? $old_data['password'] : '' ?>">
                        </div>
                    </div>
                    <!-- <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" id="min_order_amount" name="min_order_amount" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..?)\../g, '$1');" value="<?= ($old_data) ? $old_data['min_order_amount'] : '' ?>">
                        </div>
                    </div> 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea id="description" name="description" class="form-control"><?= ($old_data) ? $old_data['description'] : '' ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <!-- <input type="text" name="state" id="state" class="form-control" plcaeholder="Enter State"> -->
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <!-- <input type="text" name="city" id="city" class="form-control" plcaeholder="Enter city"> -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" id="address" name="address" class="form-control" value="<?= ($old_data) ? $old_data['address'] : '' ?>">
                        </div>
                    </div>
                    <div class="form-group">
        ...
        <option value="self">self</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" id="latitude" name="latitude" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..?)\../g, '$1');" value="<?= ($old_data) ? $old_data['lat'] : '' ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Longitude</label>
                        <div class="col-sm-10">
                            <input type="text" id="longitude" name="longitude" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..?)\../g, '$1');" value="<?= ($old_data) ? $old_data['lng'] : '' ?>">
                        </div>
                    </div> -->
                    <!-- <div class="form-group">
...
<script type="text/javascript">
    ...
    $('#btn_vendorshops').click(function () {
        ...
        var ph = $('#mobile').val();
        if ($('#shop_name').val() == '' || $('#shop_name').val().trim()=="")
        {
        ...
        } else if ($('#shop_logo').val() == '')
        {
            ...
            $('#shop_logo').focus();
            return false;
        } else if ($('#owner_name').val() == '' || $('#owner_name').val().trim()=="")
        {
        ...
        } else if (ph.length != 10)
        {
            ...
            $('#mobile').focus();
            return false;
        } else if ($('#password').val() == '' || $('#password').val().trim()=="")
        {
