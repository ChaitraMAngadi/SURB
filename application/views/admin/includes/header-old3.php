...
<?php if($show_sales): ?>
                        ...
                        <?php endif; ?>
                        <li class="<?php  if($page_name == 'vendors_shops' || $page_name == 'order_weekly_reports' || $page_name == 'inactive_vendors_shops' || $page_name == 'vendors_shops/add'){ echo 'active'; }?>">
...
?>
<?php if($show_settings || $show_admin): ?>
