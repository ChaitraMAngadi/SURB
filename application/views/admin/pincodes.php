                            ...
                            foreach ($pincodes as $loc) {
                                ...
                                <tr class="gradeX">
                                    ...
                                    <td>
                                        ...
                                        <a href="<?= base_url() ?>admin/pincodes/delete/<?= $loc->id; ?>"><button class="btn btn-xs btn-danger" onclick="if(!confirm('Are you sure you want to delete this Pincode?')) return false;">Delete</button></a></td>
                                </tr>
                                <?php
                                $i++;
                              }
