                            ...
                            <!--                            <div class="col-md-2">
                                                            <a href="<?php echo base_url(); ?>admin/orders/pending/pending">
                                                                <div class="widget style1 navy-bg">
                                                                    <div class="row">
                            <?php
                            $ord_qry = $this->db->query("select * from orders where order_status=1 group by session_id");
                            ...
                            <div class="col-md-2">
                                <a href="<?php echo base_url(); ?>admin/orders">
                                    <div class="widget style1 blue-bg">
                                        <div class="row">
                                            <?php
                                            $allorder_qry = $this->db->query("select * from orders where order_status != 1 group by session_id");
                                ...
                                <a href="<?php echo base_url(); ?>admin/orders/pending/accepted_vendor">
                                    <div class="widget style1 navy-bg">
                                        <div class="row">
                                            ...
                                            $in_accept = $this->common_model->get_data_with_condition(['order_status' => 2], 'orders');
                                ...
                                <a href="<?php echo base_url(); ?>admin/orders/pending/pickuorders">
                                    <div class="widget style1 blue-bg">
                                        <div class="row">
                                            ...
                                            //session id wise data
                                            $this->db->group_by('session_id');
                                            $in_courier = $this->common_model->get_data_with_condition(['order_status' => 3], 'orders');
                                            //multiple vendor orders in one session
                                ...
                                <a href="<?php echo base_url(); ?>admin/orders/pending/ondelivery">
                                    <div class="widget style1 blue-bg">
                                        <div class="row">
                                            ...
                                            //session id wise data
                                            $this->db->group_by('session_id');
                                            $in_shipped = $this->common_model->get_data_with_condition(['order_status' => 4], 'orders');
                                            //multiple vendor orders in one session
                                ...
                                <a href="<?php echo base_url(); ?>admin/orders/pending/completed">
                                    <div class="widget style1 blue-bg">
                                        <div class="row">
                                            ...
                                            //session id wise data
                                            $this->db->group_by('session_id');
                                            $in_delivered = $this->common_model->get_data_with_condition(['order_status' => 5], 'orders');
                                            //multiple vendor orders in one session
                            ...
                            <!--                            <div class="col-md-2">
                                                            <a href="<?php echo base_url(); ?>admin/orders/pending/cancelled">
                                                                <div class="widget style1 blue-bg">
                                                                    <div class="row">
                            <?php
                            $cancelled_qry = $this->db->query("select * from orders where order_status=6 group by session_id");
...
<?php if($show_return): ?>
                    ...
                    <hr>
                    <form method="get" action="<?= base_url() ?>admin/orders" id="filter_purchase_form">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <div class="input-group">
                                    ...
                                    <a href="<?= base_url() ?>admin/orders"><input type="button" class="btn btn-danger mt-2" name="reset" value="Reset"></a>
                                </div>
                            </div>
                        </div>
                    </form>
            ...
            <!--                                <td><?php
                                            ...
                                            <td>
                                                ...
                                                <?php } else if ($display_status == 2) { ?>
                                                    ...
                                                    <a onclick="return confirm('Do you want to cancel this order?')" href="<?php echo base_url(); ?>admin/orders/orderCancel/<?php echo $ord->session_id; ?>"><button class="btn btn-danger">Cancel</button></a>
