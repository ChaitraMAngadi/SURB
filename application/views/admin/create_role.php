...
<body> -->
    <!-- <div class="container create-role-container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <h2 class="mb-4 text-center times-font">Create New Role</h2>
                <?php if (isset($success_message)): ?>
                    <div id="successAlert" class="alert alert-success"><?= $success_message; ?></div>
                <?php endif; ?>
                <form id="createRoleForm">
                    <div class="form-group">
                        <label for="role_name" class="times-font">Role Name</label>
                        <input type="text" class="form-control" id="role_name" name="role_name" required>
                    </div>
                    <div class="form-group">
                        <label for="max_users" class="times-font">Max Users</label>
                        <input type="number" class="form-control" id="max_users" name="max_users" required>
                    </div>
                    <div class="form-group">
                        <label class="times-font">Permissions</label><br>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="select_all" name="select_all">
                            <label class="form-check-label times-font" for="select_all">Select All</label>
                        </div>
                        <div class="row">
                            <?php foreach ($features as $feature): ?>
                                <div class="col-md-4">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label times-font" for="feature_<?= $feature->id; ?>"><?= $feature->name; ?></label>
                                    </div>
                                </div>
                            <?php endforeach; ?>
                        </div>
                    ...
                    <div class="text-center">
                        <button type="button" id="submitBtn" class="btn btn-primary" style="cursor: pointer;">Create Role</button>
                    </div>
                </form>
            </div>
        </div>
