    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <form method="post" class="form-horizontal" action="<?= base_url() ?>admin/pincodes/update">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" name="state_id" id="state_id">
                                ...
                                foreach ($stte_row as $value) {
                                    ?>
                                    <option value="<?php echo $value->id; ?>" <?php if ($value->id == $location->state_id) {
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" name="city_id" id="city_id">
                                ...
                                foreach ($cities as $value) {
                                    ?>
                                    <option value="<?php echo $value->id; ?>" <?php if ($value->id == $location->city_id) {
                                    echo "selected='selected'";
...
<?php } ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="pincode" id="pincode" class="form-control" placeholder="Enter Pincode" value="<?php echo $location->pincode; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="status" id="status" class="form-control">
                                <option value="1" <?php if ($location->status == 1) {
    echo "selected='selected'";
} ?>>Active</option>
                                <option value="0" <?php if ($location->status == 0) {
    echo "selected='selected'";
} ?>>Inactive</option>
                            </select>
                        </div>
