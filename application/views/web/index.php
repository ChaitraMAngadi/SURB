        ...
        <div class="slider_area owl-carousel">
            ...
            foreach ($banners as $bnr) {
                ...
                ?>
                        ...
                        <a href="<?php echo base_url(); ?>single-banner-product/<?php echo $bnr['tag_id']; ?>">
            ...
            <div class="row">
                ...
                foreach ($bannerads as $banner) {
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        ...
                        <a href="<?php echo base_url(); ?>single-banner-product/<?php echo $banner['random_number']; ?>">
        ...
        <div class="row">
            ...
            foreach ($lastbannerads as $lastbanner) {
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 mb-4">
                    ...
                    <a href="<?php echo base_url(); ?>single-banner-product/<?php echo $lastbanner['random_number']; ?>">
