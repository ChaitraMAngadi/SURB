    ...
    <div class="slider_area owl-carousel">
        ...
        foreach ($banners as $bnr) {
            ...
            <?php if ($bnr['type'] == 'products') { ?>
                <a href="<?php echo base_url(); ?>single-product/<?php echo $bnr['product_details']['seo_url']; ?>">
                <?php } else { ?>
                    <a href="<?php echo base_url(); ?>products/<?php echo $cat_seo_url; ?>">
                    <?php } ?>
                                                            ...
                                                            <div class="col-lg-7">
                                                                <form method="post" id='questionary-form' action="<?php echo base_url(); ?>products-filter-by-questionaries" onsubmit="return chkform()">
                                                                    ...
                                                                    <div class="row qaoptions">
                                                                        ...
                                                                        <?php foreach ($category['question'] as $key => $que) {
                                                                            ?>
                                                                            <div class="col-md-12">
                                                                                <label class="custradiobtn"><?php echo $que->question; ?>
                                                                                    <input type="checkbox" class="questions" name="question[]" value="<?php echo $que->id; ?>">
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <label class="custradiobtn">Others
                                                                                <input type="checkbox" id="other" onchange="msgbox(this,'<?= $category['id'] ?>')" class="questions" name="question[]" value="other">
                                                                                <span class="checkmark"></span>
                                                                            </label>
                                                                        </div>
                                                                        <!--                                    <div class="col-md-12">
                                                                        ...
                                                                        <div class="col-md-12 msgothers" id="message-<?= $category['id'] ?>" style="display:none;">
                                                                        ...
                                                                        <div class="col-md-12" style="background-color:#081f66;">
                                                                            ...
                                                                            <a href="<?php echo base_url(); ?>products/<?php echo $category['seo_url']; ?>" style="color:white !important" class="btn btn-outline-light mt-2 mr-2 btn-lg float-right">SKIP</a>
                                                                        </div>
                                                                    </div>
                                                                </form>
                                                            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            foreach ($bannerads as $banner) {
                ...
                ?>
                <div class="col-lg-4 col-md-4 col-sm-6">
                        <?php if ($banner['type'] == 'products') { ?>
                        <a href="<?php echo base_url(); ?>single-product/<?php echo $banner['product_details']['seo_url']; ?>">
                            <?php } else { ?>
                            <a href="<?php echo base_url(); ?>products/<?php echo $cat_seo_url; ?>">
    <?php } ?>
                            <div class="single_banner">
...
<?php foreach ($topdeals as $deals) {
    if ($deals['product_status'] == 1) { ?>
        ...
        <?php } ?>
                                        ...
                                        <div class="wishlist">
                                            <a title="Add to Wishlist" onclick="addremoveFavorite(<?php echo $deals['id']; ?>)"><span id="favoritecls_<?php echo $deals['id']; ?>" class="<?php
                                    ...
                                    <figcaption class="product_content">
                                        <div class="product_content_inner">
                                            ...
                                            <h4 class="product_name"><a href="<?php echo base_url(); ?>single-product/<?php echo $deals['seo_url']; ?>"><?php echo $deals['name']; ?></a></h4>
...
<div class="container my-5">
    ...
    <?php if ($lastbanner['type'] == 'products') { ?>
                    <a href="<?php echo base_url(); ?>single-product/<?php echo $lastbanner['product_details']['seo_url']; ?>">
    <?php } ?>
                    <div class="single_banner">
                        <div class="banner_thumb">
                            <img src="<?php echo $lastbanner['image']; ?>" alt="">
                        </div>
                        ...
                        <article class="single_product">
                            ...
                            <figure>
                                <div class="product_thumb">
                                    ...
                                    <div class="wishlist">
                                        <a title="Add to Wishlist" onclick="addremoveFavorite(<?php echo $deals['id']; ?>)"><span id="rendingfavorites_<?php echo $deals['id']; ?>" class="<?php
                                            if ($deals['whishlist_status'] == true) {
                                                echo 'fas';
                                            } else {
                                                echo 'fal';
        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <div class="section_title product_shop_title">
                    ...
                    <h2>New arrivals</h2>
                    <a href="<?php echo base_url() ?>web/viewallProducts/new_arrival" class="btn btn-sm pink-btn float-right"> View All </a>
                </div>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-11">
            <div class="img-thubnail rounded">
                <iframe width="100%" height="700" src="https://www.youtube.com/embed/<?= $home_video->home_video ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        ...
        <div class="banner_thumb">
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <a <?php if ($lastbannerads['type'] == 'shops') { ?> href="<?php echo base_url(); ?>web/store/<?php echo $lastbannerads['product_details']['seo_url']; ?>" <?php } else { ?>href="<?php echo base_url(); ?>single-product/<?php echo $lastbannerads['product_details']['seo_url']; ?>"<?php } ?>><img src="<?php echo $lastbannerads['image']; ?>" alt="" class="img-fluid"></a>
                </div>
                <div class="col-lg-6 col-md-6">
                ...
                <a <?php if ($lastbannerads['type'] == 'shops') { ?> href="<?php echo base_url(); ?>web/store/<?php echo $lastbannerads['product_details']['seo_url']; ?>" <?php } else { ?>href="<?php echo base_url(); ?>single-product/<?php echo $lastbannerads['product_details']['seo_url']; ?>"<?php } ?>>shop now</a>
...
<script>
    function chkform() {
        ...
        if (already_checked > 0) {
            ...
            toastr.error('Select atleast one question from the list to proceed');
            return false;
        }
        $('#questionary-form').trigger("reset");
    }

    function msgbox(ele,cat_id) {
