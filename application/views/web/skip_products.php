            ...
            <?php if ($products) { ?>
                <div class="col-lg-3">
                    ...
                    <div class="filter-sidebar d-lg-none d-block">
                        ...
                        <div id="mySidenav" class="sidenav visible-sm visible-xs" style="background-color: #0857c0;">
                                ...
                                <div class="card mb-3">
                                    <div class="card-body">
                                        <div class="widget_list widget_brand">
                                            <h3>Brand <?php //print_r($brands); ?></h3>
                                            <ul>
                                                <?php
            ...
            <div class="col-lg-9">
                <div class="row">
                    ...
                    if ($products) {
                        ...
                        <div class="noproduct">
                            <center>
                                <a href="<?=base_url()?>"><button class="abs-btn" style="margin-left: 10px;" type="button">Back</button></a>
