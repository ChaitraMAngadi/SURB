                                ...
                                <article class="single_categories">
                                    <figure>
                                        <div class="categories_thumb">
                                            ...
                                            <a href="<?php echo base_url(); ?>web/view_subcategories"><img src="<?php echo $category['image']; ?>" alt=""></a>
                                        </div>
                                        <figcaption class="categories_content">
                                            <h4 class="product_name"><a href="<?php echo base_url(); ?>web/view_subcategories"><?php echo $category['title']; ?></a></h4>
                                        </figcaption>
                                    </figure>
                                </article>
                            </div>
