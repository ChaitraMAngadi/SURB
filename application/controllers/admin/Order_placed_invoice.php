...
class Order_placed_invoice extends MY_Controller {
    ...
    function index() {
        ...
        $data['page_name'] = 'order_placed_invoice';
        $data['delivered_invoice'] = $this->admin_model->get_placed_invoice();
                
        $this->load->view('admin/includes/header', $data);
        $this->load->view('admin/order_placed_invoice', $this->data);
    ...
    function edit($id)
    {
     $this->data['edit']= $this->admin_model->get_edit_placed($id);
    //print_r($edit);die;
     $this->load->view('admin/includes/header', $data);
     $this->load->view('admin/edit_order_placed_invoice', $this->data);
     $this->load->view('admin/includes/footer');
    }
    ...
    function update(){
     ...
     $update = $this->admin_model->updplaced($data);
     //print_r($id);die;
     if($update){
         //$this->session->set_tempdata('status_changed', 'Status Changed .',3);
            redirect('admin/order_placed_invoice');
     }else{
