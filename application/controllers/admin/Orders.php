...
//        $data['orders'] = $qry->result();
    ...
    function pending($value) {
        ...
        if ($value == 'pending') {
            ...
            $config['base_url'] = base_url() . 'admin/orders/pending/pending';
            $config['total_rows'] = $this->data['count_data'] = $count->num_rows();
            $config['per_page'] = 10;
            // $this->data['page_title'] = 'Total '.$config['total_rows'].' Books';
            $config['page_query_string'] = true;
...
//            $qry = $this->db->query("select * from orders where order_status=1 order by id desc");
            ...
            $qry = $this->db->query("select * from orders where order_status=2 and accept_status=0 group by session_id order by id desc");
        } else if ($value == 'accepted_vendor') {

            $count = $this->db->query("select * from orders where order_status=2 group by session_id order by id desc");
            $this->data['count_data'] = $count->num_rows();

            $config['base_url'] = base_url() . 'admin/orders/pending/accepted_vendor';
            $config['total_rows'] = $this->data['count_data'] = $count->num_rows();
            $config['per_page'] = 10;
            // $this->data['page_title'] = 'Total '.$config['total_rows'].' Books';
            $config['page_query_string'] = true;
...
//            $qry = $this->db->query("select * from orders where order_status=2 order by id desc");
            ...
            $count = $this->db->query("select * from orders where order_status=3 group by session_id order by id desc");
            $this->data['count_data'] = $count->num_rows();

            $config['base_url'] = base_url() . 'admin/orders/pending/pickuorders';
            $config['total_rows'] = $this->data['count_data'] = $count->num_rows();
            $config['per_page'] = 10;
            // $this->data['page_title'] = 'Total '.$config['total_rows'].' Books';
            $config['page_query_string'] = true;
...
//            $qry = $this->db->query("select * from orders where order_status=3 order by id desc");
            ...
            $count = $this->db->query("select * from orders where order_status=4 group by session_id order by id desc");
            $this->data['count_data'] = $count->num_rows();

            $config['base_url'] = base_url() . 'admin/orders/pending/ondelivery';
            $config['total_rows'] = $this->data['count_data'] = $count->num_rows();
            $config['per_page'] = 10;
            // $this->data['page_title'] = 'Total '.$config['total_rows'].' Books';
            $config['page_query_string'] = true;
...
//            $qry = $this->db->query("select * from orders where order_status=4 order by id desc");
            ...
            $count = $this->db->query("select * from orders where order_status=5 group by session_id order by id desc");
            $this->data['count_data'] = $count->num_rows();

            $config['base_url'] = base_url() . 'admin/orders/pending/completed';
            $config['total_rows'] = $this->data['count_data'] = $count->num_rows();
            $config['per_page'] = 10;
            // $this->data['page_title'] = 'Total '.$config['total_rows'].' Books';
            $config['page_query_string'] = true;
...
//            $qry = $this->db->query("select * from orders where order_status=5 order by id desc");
            ...
            $count = $this->db->query("select * from orders where order_status=6 group by session_id order by id desc");
            $this->data['count_data'] = $count->num_rows();

            $config['base_url'] = base_url() . 'admin/orders/pending/cancelled';
            $config['total_rows'] = $this->data['count_data'] = $count->num_rows();
            $config['per_page'] = 10;
            // $this->data['page_title'] = 'Total '.$config['total_rows'].' Books';
            $config['page_query_string'] = true;
...
//            $qry = $this->db->query("select * from orders where order_status=6 order by id desc");
            ...
            $count = $this->db->query("select * from orders where order_status=7 group by session_id order by id desc");
            $this->data['count_data'] = $count->num_rows();

            $config['base_url'] = base_url() . 'admin/orders/pending/return';
            $config['total_rows'] = $this->data['count_data'] = $count->num_rows();
            $config['per_page'] = 10;
            // $this->data['page_title'] = 'Total '.$config['total_rows'].' Books';
            $config['page_query_string'] = true;
...
//            $qry = $this->db->query("select * from orders where order_status=7 order by id desc");
            ...
            $count = $this->db->query("select * from orders group by session_id order by id desc");
            $this->data['count_data'] = $count->num_rows();

            $config['base_url'] = base_url() . 'admin/orders/pending/allorders';
            $config['total_rows'] = $this->data['count_data'] = $count->num_rows();
            $config['per_page'] = 10;
            // $this->data['page_title'] = 'Total '.$config['total_rows'].' Books';
            $config['page_query_string'] = true;
...
//            $qry = $this->db->query("select * from orders order by id desc");
        ...
        foreach ($orders_get as $row) {
            $vendor_orders = $this->common_model->get_data_with_condition(['session_id' => $row->session_id], 'orders');
            //get all status
