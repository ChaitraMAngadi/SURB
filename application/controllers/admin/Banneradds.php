...
class Banneradds extends CI_Controller {
    ...
    function index() {
        ...
        $qry = $this->db->query("select * from bannerads where shop_id=0");
       // $qry = $this->db->get('bannerads')->result();
        $data['banners'] = $qry->result();
        $this->load->view('admin/includes/header', $this->data);
        $this->load->view('admin/bannerads', $data);
    ...
    function add() {
        ...
        $this->load->view('admin/addbannerad', $this->data);
    ...
    function insert() {
        ...
        if ($insert_query) {
            ...
            redirect('admin/banneradds');

            die();

        } else {

            redirect('admin/bannerads/add');
    ...
    function edit($id) {
        ...
        $this->load->view('admin/editbannerad', $data);
    ...
    function update() {
        ...
        if ($update_query) {
            ...
            redirect('admin/bannerads/edit/' . $id);
            die();
        }
