...
class HeroProducts_week extends MY_Controller {
    ...
    function index() {
        $this->data['page_name'] = 'HeroProducts_week';
        $this->data['title'] = 'HeroProducts_week';
 ...
 ");
        ...
        $this->load->view('admin/HeroProducts_week', $this->data);
