...
class Orders_weekly extends MY_Controller {
    ...
    function index() {
        ...
        $config['base_url'] = base_url() . 'admin/orders_weekly';
        ...
        $where = array(
            'order_status !=' => 1,
            'order_date >=' => date('Y-m-d', strtotime('-1 week', strtotime('yesterday'))),
            'order_date <=' => date('Y-m-d', strtotime('yesterday'))
        );
...
//        $data['orders'] = $qry->result();
        ...
        $this->load->view('admin/orders_weekly', $this->data);
    ...
    function pending($value) {
        ...
        if ($value == 'pending') {
            ...
            $config['base_url'] = base_url() . 'admin/orders_weekly/pending/pending';
            $config['total_rows'] = $this->data['count_data'] = $count->num_rows();
            $config['per_page'] = 10;
            // $this->data['page_title'] = 'Total '.$config['total_rows'].' Books';
            $config['page_query_string'] = true;
...
//            $qry = $this->db->query("select * from orders where order_status=1 order by id desc");
            ...
            $qry = $this->db->query("select * from orders where order_status=2 and accept_status=0 and order_date between '$from_date' AND '$to_date' group by session_id order by id desc");
        } else if ($value == 'accepted_vendor') {

            $count = $this->db->query("select * from orders where order_status=2 and order_date between '$from_date' AND '$to_date' group by session_id order by id desc");
            $this->data['count_data'] = $count->num_rows();

            $config['base_url'] = base_url() . 'admin/orders_weekly/pending/accepted_vendor';
            $config['total_rows'] = $this->data['count_data'] = $count->num_rows();
            $config['per_page'] = 10;
            // $this->data['page_title'] = 'Total '.$config['total_rows'].' Books';
            $config['page_query_string'] = true;
...
//            $qry = $this->db->query("select * from orders where order_status=2 order by id desc");
            ...
            $count = $this->db->query("select * from orders where order_status=3 and order_date between '$from_date' AND '$to_date' group by session_id order by id desc");
            $this->data['count_data'] = $count->num_rows();

            $config['base_url'] = base_url() . 'admin/orders_weekly/pending/pickuorders';
            $config['total_rows'] = $this->data['count_data'] = $count->num_rows();
            $config['per_page'] = 10;
            // $this->data['page_title'] = 'Total '.$config['total_rows'].' Books';
            $config['page_query_string'] = true;
...
//            $qry = $this->db->query("select * from orders where order_status=3 order by id desc");
            ...
            $count = $this->db->query("select * from orders where order_status=4 and order_date between '$from_date' AND '$to_date' group by session_id order by id desc");
            $this->data['count_data'] = $count->num_rows();

            $config['base_url'] = base_url() . 'admin/orders_weekly/pending/ondelivery';
            $config['total_rows'] = $this->data['count_data'] = $count->num_rows();
            $config['per_page'] = 10;
            // $this->data['page_title'] = 'Total '.$config['total_rows'].' Books';
            $config['page_query_string'] = true;
...
//            $qry = $this->db->query("select * from orders where order_status=4 order by id desc");
            ...
            $count = $this->db->query("select * from orders where order_status=5  and order_date between '$from_date' AND '$to_date' group by session_id order by id desc");
            $this->data['count_data'] = $count->num_rows();

            $config['base_url'] = base_url() . 'admin/orders_weekly/pending/completed';
            $config['total_rows'] = $this->data['count_data'] = $count->num_rows();
            $config['per_page'] = 10;
            // $this->data['page_title'] = 'Total '.$config['total_rows'].' Books';
            $config['page_query_string'] = true;
...
//            $qry = $this->db->query("select * from orders where order_status=5 order by id desc");
            ...
            $count = $this->db->query("select * from orders where order_status=6 and order_date between '$from_date' AND '$to_date' group by session_id order by id desc");
            $this->data['count_data'] = $count->num_rows();

            $config['base_url'] = base_url() . 'admin/orders_weekly/pending/cancelled';
            $config['total_rows'] = $this->data['count_data'] = $count->num_rows();
            $config['per_page'] = 10;
            // $this->data['page_title'] = 'Total '.$config['total_rows'].' Books';
            $config['page_query_string'] = true;
...
//            $qry = $this->db->query("select * from orders where order_status=6 order by id desc");
            ...
            $count = $this->db->query("select * from orders where order_status=7 and order_date between '$from_date' AND '$to_date' group by session_id order by id desc");
            $this->data['count_data'] = $count->num_rows();

            $config['base_url'] = base_url() . 'admin/orders_weekly/pending/return';
            $config['total_rows'] = $this->data['count_data'] = $count->num_rows();
            $config['per_page'] = 10;
            // $this->data['page_title'] = 'Total '.$config['total_rows'].' Books';
            $config['page_query_string'] = true;
...
//            $qry = $this->db->query("select * from orders where order_status=7 order by id desc");
            ...
            $count = $this->db->query("select * from orders where order_date between '$from_date' and '$to_date' group by session_id order by id desc");
            $this->data['count_data'] = $count->num_rows();

            $config['base_url'] = base_url() . 'admin/orders_weekly/pending/allorders';
            $config['total_rows'] = $this->data['count_data'] = $count->num_rows();
            $config['per_page'] = 10;
            // $this->data['page_title'] = 'Total '.$config['total_rows'].' Books';
            $config['page_query_string'] = true;
            ...
            $table = "orders";
            $this->db->select("*");
            $this->db->where('order_date >=', $from_date); // Condition for order_date greater than or equal to $from_date
            $this->db->where('order_date <=', $to_date);
            $this->db->order_by('id', 'desc');
...
//            $qry = $this->db->query("select * from orders order by id desc");
        ...
        foreach ($orders_get as $row) {
            ...
            $vendor_orders = $this->common_model->get_data_with_condition($vendor_array, 'orders');
            //get all status
